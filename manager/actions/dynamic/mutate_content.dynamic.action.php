...
<div class="tab-page" id="tabPage99" <?php if(strstr($_SERVER['HTTP_USER_AGENT'],'MSIE')) echo ' style="position:absolute; top:18px; left:0px"';?>>
  <div class="tab">
    <img src='./media/images/misc/dot.gif' alt="." />&nbsp;<?php echo $_lang['document_meta_tags']; ?>
  </div>
  <script type="text/javascript">
    tpSettings.addTabPage(document.getElementById("tabPage99"));
  </script>

  <div class="sectionBody">
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		<tr style="height: 24px;">
			<td width="150"><span class='warning'><?php echo $_lang['document_meta_title']; ?></span></td>
			<td><input name="meta_title" type="text" maxlength="255" value="<?php echo stripslashes($content['meta_title']);?>" class="inputBox" style="width:300px;" onChange="documentDirty=true;">&nbsp;&nbsp;<img src="./media/images/icons/b02_trans.gif" onMouseover="this.src='./media/images/icons/b02.gif';" onMouseout="this.src='./media/images/icons/b02_trans.gif';" alt="<?php echo $_lang['document_meta_title_help']; ?>" onClick="alert(this.alt);" style="cursor:help;"></td>
		</tr>
		<tr style="height: 24px;">
			<td width="150"><span class='warning'><?php echo $_lang['document_meta_description']; ?></span></td>
			<td><input name="meta_description" type="text" maxlength="255" value="<?php echo stripslashes($content['meta_description']);?>" class="inputBox" style="width:300px;" onChange="documentDirty=true;">&nbsp;&nbsp;<img src="./media/images/icons/b02_trans.gif" onMouseover="this.src='./media/images/icons/b02.gif';" onMouseout="this.src='./media/images/icons/b02_trans.gif';" alt="<?php echo $_lang['document_meta_description_help']; ?>" onClick="alert(this.alt);" style="cursor:help;"></td>
		</tr>
		<tr style="height: 24px;">
			<td width="150"><span class='warning'><?php echo $_lang['document_meta_keywords']; ?></span></td>
			<td><input name="meta_keywords" type="text" maxlength="255" value="<?php echo stripslashes($content['meta_keywords']);?>" class="inputBox" style="width:300px;" onChange="documentDirty=true;">&nbsp;&nbsp;<img src="./media/images/icons/b02_trans.gif" onMouseover="this.src='./media/images/icons/b02.gif';" onMouseout="this.src='./media/images/icons/b02_trans.gif';" alt="<?php echo $_lang['document_meta_keywords_help']; ?>" onClick="alert(this.alt);" style="cursor:help;"></td>
		</tr>
	</table>
...
<!-- new previous versions tab -->

<!-- <div class="tab-page" id="tabPage100"> -->
<div class="tab-page" id="tabPage100" <?php if(strstr($_SERVER['HTTP_USER_AGENT'],'MSIE')) echo ' style="position:absolute; top:18px; left:0px"';?>>
  <div class="tab">
    <img src='./media/images/misc/dot.gif' alt="." />&nbsp;<?php echo $_lang['document_previous_versions']; ?>
  </div>
  <script type="text/javascript">
    tpSettings.addTabPage(document.getElementById("tabPage100"));
  </script>
  ...
  <div class="sectionBody">
	<p>
		<?php
		if(isset($_GET['id'])){
			  $sql = "SELECT * FROM $dbase.".$table_prefix."site_content_versions WHERE $dbase.".$table_prefix."site_content_versions.orig_id = $id ORDER BY $dbase.".$table_prefix."site_content_versions.versionedon DESC;";
			  $vrs = mysql_query($sql);
			  $nums = mysql_num_rows($vrs);
			  if(!empty($vrs) && $nums>0){
			  ?>
			  	<table width="100%" cellpadding="5">
					<tr>
						<th align="left"><?php echo $_lang['document_previous_version_date']; ?></th>
						<th align="left"><?php echo $_lang['document_previous_version_editedby']; ?></th>
						<th align="left"><?php echo $_lang['document_previous_version_actions']; ?></th>
					</tr>
			  <?php
			  	while($r = mysql_fetch_assoc($vrs)){
					?>
						<tr>
							<td><?php echo strftime($date_format.$sep.$time_format, $r['versionedon']);?></td>
							<td>
							<?php
								// get username who edited this version last
								$usql = "SELECT * FROM $dbase.".$table_prefix."manager_users WHERE id=".$r['editedby']." LIMIT 1;";
								$urs = mysql_query($usql);
								if($urs){
									$urow = mysql_fetch_assoc($urs);
									$username = $urow['username'];
									// now get full name
									$usql = "SELECT * FROM $dbase.".$table_prefix."user_attributes WHERE internalKey=".$r['editedby']." LIMIT 1;";
									$urs = mysql_query($usql);
									$urow = mysql_fetch_assoc($urs);
							...
							<td nowrap="nowrap"><a href="#" onclick="new Effect.toggle('doc_<?php echo $r['orig_id'];?>','blind'); return false;">View Info</a> <a href="index.php?a=5&revid=<?php echo $r['id']; ?>&id=<?php echo $content['id'];?>&mode=999" onclick="return revert();">Revert</a>	
							</td>
						</tr>
						<tr>
							<td colspan="3">
							<div id="doc_<?php echo $r['orig_id'];?>" style="display:none;">
			  ...
			  ?>
			  	<p><?php echo $_lang['document_no_previous_versions']; ?></p>
			  <?php
			  }
