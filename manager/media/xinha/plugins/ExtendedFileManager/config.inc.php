...
// get the Etomite configuration file
include("../../../../includes/config.inc.php");
/*
// check for a valid Etomite session
include("../../validSession.php");
if(!$validSession)
{
  die("Access Denied");
}
...
// END - Etomite Settings
// other Etomite-specific settings can be found by searching for 'Etomite'
...
$IMConfig['images_dir'] = $im_plugin_base_dir; // Etomite
...
$IMConfig['images_url'] = $im_plugin_base_url; // Etomite

// FileManager directory settings based on Etomite confiuration settings
$IMConfig['files_url'] = $fm_plugin_document_url; // Etomite
$IMConfig['files_dir'] = $fm_path; // Etomite
...
*/
$IMConfig['allow_upload'] = true; // Etomite
...
$IMConfig['allowed_link_extensions'] = explode(",", $fm_upload_files); // Etomite
