...
// Modified: 2013-11-06 [v2.3] by John Carlson
// - Updated for etoFork
...
define('MANAGER_PATH', absolute_base_path.'manager/');

define("www_base_path", $protocol . '{WWW_PATH}');
define("MANAGER_URL", $protocol . www_base_path.'manager/');

define("ASSETS_PATH", absolute_base_path.'assets/');
define("ASSETS_URL", $protocol . www_base_path.'assets/');

define("MODULES_PATH", absolute_base_path.'/modules/');
define("MODULES_URL", $protocol . www_base_path.'modules/');
