...
$_lang["terms_msg"] = "&quot;I agree to use etoFork in Accordance with the GPL.&quot;";
...
$_lang["save_tree"] = "Tree Saved";
$_lang["save_tree_error"] = "There was an error saving the tree";
$_lang["restore_tree"] = "Restore tree (default width)";
$_lang["help"] = "Help";
$_lang["credits"] = "Credits";
$_lang["about"] = "About etoFork";
...
$_lang["configcheck_installer_msg"] = "The install/ directory contains the installer for etoFork. Just imagine what might happen if an evil person finds this folder and runs the installer! He'd probably not get too far, because he'll need to enter some user information for the database, but it's still best to remove this folder from your server.";
$_lang["configcheck_cache"] = "cache directory not writable";
$_lang["configcheck_cache_msg"] = "etoFork cannot write to the cache directory. etoFork will still function as expected, but no caching will take place. To solve this, make the /_cache/ directory writable.";
...
$_lang["to"] = "to";
$_lang["total"] = "total";
$_lang["settings_title"] = "etoFork configuration";
...
$_lang["language_message"] = "Select the language for the etoFork Manager.";
...
$_lang["enabledebug_message"] = "Selecting 'Yes' will show some debug information about the different functions in etoFork. Generally, you won't need to use this, however, if you're trying to solve a bug, it may be handy to turn this on.";
...
$_lang['actioncomplete'] = "<b>Action was completed successfully!</b><br /> - Please wait while etoFork cleans up.";
...
$_lang['weblink_message'] = "A weblink is a reference to an object on the internet. This could be a document within etoFork, a page on another site or an image or other file on the internet.<p>";
...
$_lang['document_opt_folder_help'] = "Check this to make the document also act as a folder for other documents. You don't need to worry about this too much, as etoFork generally takes care of folder settings automatically.";
...
$_lang['document_opt_emptycache_help'] = "Leaving this field checked will make etoFork empty the cache after you save the document. This way your visitors will not see an older version of the document.";
...
$_lang['personal_prefs_message'] = "Currently there are no preferences which can be changes on a per-user basis. This section will contain options for overriding stuff like language settings, eventually. Please edit the etoFork configuration to change settings.";
...
$_lang['signupemail_message'] = "Here you can set the message sent to your users when you create an account for them and let etoFork send them an e-mail containing their username and password. <b>Note:</b> The %s codes are replaced by etoFork when it sends the message. The first %s is always replaced with the username, and the second with the password. <b>Leave the two %s codes in the e-mail, or else the username and password won't be sent in the mail and your users won't know their username or password!</b>";
...
$_lang['charset_message'] = "Please select which character encoding you wish to use in the manager. Please note that etoFork has been tested with a number of these encodings, but not all of them. For most languages, the default setting of ISO-8859-1 suffices.";
...
$_lang['layout_message'] = "Use this option to select the layout for the etoFork manager.";
...
$_lang['loading_page'] = "Please wait while etoFork loads the page...";
$_lang['filemanager_path_title'] = "File Manager Path:";
$_lang['filemanager_path_message'] = "IIS often does not populate the document_root setting properly, which is used by the file manager to determine what you can look at. If you're having problems using the file manager, make sure this path points to the root of your etoFork installation.";
...
$_lang['resolve_hostnames_message'] = "Do you want etoFork to try to resolve your visitors' hostnames when they visit your site? Resolving hostnames may create some extra server load, although your visitors won't notice this in any way.";
...
$_lang["settings_strip_image_paths_message"] = "Turning this on will have etoFork rewrite image src's to be relative instead of absolute. This is very handy if you should ever wish to move your etoFork installation (for example from a staging site to a production site). If you have no idea what this means, it's best just to leave it set to 'No'.";
...
$_lang['export_site_maxtime_message'] = "Here you can specify the number of seconds etoFork can take to export the site (overriding PHP settings). Enter 0 for unlimited time. Please note, setting 0 or a really high number can do weird things to your server and is not recommended.";
...
$_lang["defaultresourcecache_title"] = "Enable Resource Cache:";
$_lang["defaultresourcecache_message"] = "Select 'Yes' to make Chunks and Snippets Cached.";
...
$_lang["mgr_logging_disabled"] = "etoFork manager user logging (audit trail) is disabled.";
...
$_lang["useNotice_message"] = "This setting determines whether the default <b>Powered By etoFork</b> link-back is displayed. This link can be styled using the <b>#etoNotice</b> CSS element. While we kindly request that some form or credits to the etoFork project be displayed we realize that the default link-back may not fit into the overall design of some sites. Please consider donating to the etoFork Project if you would not like to provide link-back credits.";
...
$_lang["user_logged_in"] = "User Logged In";
$_lang["username_password_no_match"] = "Username and Password did not match!";
$_lang['document_saved'] = "Document Saved!";
$_lang['document_not_saved'] = "Document not Saved!";
$_lang['property_updated'] = "Property Updated!";
$_lang['property_not_updated'] = "Property not Updated!";
$_lang['documents_purged'] = "Documents Purged!";
$_lang['documents_purged_error'] = "There was an error removing all the documents!";
$_lang['locks_removed'] = "Locks Removed!";
$_lang['locks_removed_error'] = "There was an error removing locks!";
$_lang['resource_saved'] = "Resource Saved!";
